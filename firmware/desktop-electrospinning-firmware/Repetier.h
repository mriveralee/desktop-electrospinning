...
#if (SHARED_EXTRUDER_HEATER && SHARED_EXTRUDER_HEATER != ES_SHARED_HEATER_E1_AND_E2) || MIXING_EXTRUDER
...
// We only undefine the extruders that are for ESP (e.g. 1, 2, where 1 becomes the shared heater) 
#undef EXT2_HEATER_PIN
#undef EXT3_HEATER_PIN
#undef EXT4_HEATER_PIN
#undef EXT5_HEATER_PIN
